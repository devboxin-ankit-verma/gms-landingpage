...
export function SvgMechanicAI({ className = "" }: SvgProps) {
  return (
    <svg viewBox="0 0 280 220" fill="none" className={className} aria-hidden>
      <rect x="40" y="40" width="200" height="140" rx="16" fill="#F8FAFC" stroke="#E5E7EB" strokeWidth="2" />
      <circle cx="140" cy="88" r="24" fill="#EDE9FE" stroke="#8B5CF6" strokeWidth="2" />
      <rect x="108" y="108" width="64" height="48" rx="12" fill="#EDE9FE" />
      <rect x="168" y="118" width="44" height="56" rx="8" fill="white" stroke="#E5E7EB" strokeWidth="2" />
      ...
      <path d="M80 168 H200" stroke="#E5E7EB" strokeWidth="2" />
    </svg>
  );
}
...
export function SvgDashboard({ className = "" }: SvgProps) {
  return (
    <svg viewBox="0 0 280 220" fill="none" className={className} aria-hidden>
      <rect x="50" y="45" width="180" height="130" rx="12" fill="white" stroke="#E5E7EB" strokeWidth="2" />
...
export function SvgInvoice({ className = "" }: SvgProps) {
  return (
    <svg viewBox="0 0 280 220" fill="none" className={className} aria-hidden>
      <rect x="70" y="40" width="140" height="150" rx="10" fill="white" stroke="#E5E7EB" strokeWidth="2" />
      ...
      <rect x="90" y="140" width="100" height="32" rx="8" fill="#EDE9FE" stroke="#8B5CF6" strokeWidth="2" />
...
export function SvgCustomerAI({ className = "" }: SvgProps) {
  return (
    <svg viewBox="0 0 280 220" fill="none" className={className} aria-hidden>
      <circle cx="140" cy="100" r="50" fill="#F8FAFC" stroke="#E5E7EB" strokeWidth="2" />
      <circle cx="140" cy="88" r="18" fill="#EDE9FE" stroke="#8B5CF6" strokeWidth="2" />
      <path d="M110 130 Q140 155 170 130" fill="#EDE9FE" stroke="#8B5CF6" strokeWidth="2" />
      <rect x="185" y="75" width="50" height="70" rx="8" fill="white" stroke="#E5E7EB" strokeWidth="2" />
...
export function SvgWorkshop({ className = "" }: SvgProps) {
  return (
    <svg viewBox="0 0 280 220" fill="none" className={className} aria-hidden>
      <path d="M60 160 H220 V100 L140 55 L60 100 Z" fill="#F8FAFC" stroke="#E5E7EB" strokeWidth="2" strokeLinejoin="round" />
      <rect x="115" y="120" width="50" height="40" rx="4" fill="white" stroke="#8B5CF6" strokeWidth="2" />
...
export function SvgInventory({ className = "" }: SvgProps) {
  return (
    <svg viewBox="0 0 280 220" fill="none" className={className} aria-hidden>
      <rect x="55" y="50" width="170" height="120" rx="10" fill="#F8FAFC" stroke="#E5E7EB" strokeWidth="2" />
      {[0, 1, 2].map((r) =>
        [0, 1, 2].map((c) => (
          <rect
            key={`${r}-${c}`}
...
export function SvgAnalytics({ className = "" }: SvgProps) {
  return (
    <svg viewBox="0 0 280 220" fill="none" className={className} aria-hidden>
      <rect x="50" y="50" width="180" height="120" rx="12" fill="white" stroke="#E5E7EB" strokeWidth="2" />
      <path
